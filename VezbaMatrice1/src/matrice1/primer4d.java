...
public class primer4d {

	public static void main(String[] args) {
		Scanner sc = new Scanner(System.in);

		System.out.println("Unesite broj redova za prvu matricu");
		int red = sc.nextInt();
		System.out.println("Unesite broj kolona prve matrice");
		int kolona = sc.nextInt();
		
		
		System.out.println("Unesite vrednost za skalar");
		int s = sc.nextInt();
		...
		System.out.println("Skalar matrice a: ");
		for (int i = 0; i < red; i++) {
			for (int j = 0; j < kolona; j++) {
				System.out.print(a[i][j] + "  ");
			}
		...
		System.out.println("Skalar matrice b: ");
		for (int i = 0; i < red; i++) {
			for (int j = 0; j < kolona; j++) {
				System.out.print(b[i][j] + "  ");
			}
